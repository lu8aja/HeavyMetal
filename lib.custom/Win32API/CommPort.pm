...
#
# NOTE: This is a locally modified version of CommPort.pm, done to
# add support for arbitrary baud rate setting.
#
...
sub is_baudrate {
    ...
    if (@_) {
        ...
        return unless ($variable_baud || defined $self->{"_L_BAUD"}{$_[0]});
